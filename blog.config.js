...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ACGgame', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个个人搭建的瑟瑟游戏分享网站', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '黄油, 游戏,黄游,老司机,游戏分享,ACG', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个网络小白, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的网站🎉',
